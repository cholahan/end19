...
There might be some margin of error because they were geocoded, and there might be an margin of error concerning information the dataset (gender, date, etc). 
</p>
<hr>
